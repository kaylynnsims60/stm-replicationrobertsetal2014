...
This repository contains replication materials for a Structural Topic Model (STM) analysis based on Gadarian et al. The purpose of this project is to reproduce key figures and analytical steps from the original paper while documenting the workflow and challenges of replicating STM analyses using the modern `stm` package in R.
